<!-- Close the container div from header -->
</div>
...
<footer>
    <div class="container footer-container">
        ...
        <div class="footer-section">
            ...
            <ul>
                <li><a href="#">Canberra to Sydney</a></li>
                <li><a href="#">Canberra to Melbourne</a></li>
                <li><a href="#">Canberra to Brisbane</a></li>
                <li><a href="#">Canberra to Adelaide</a></li>
                <li><a href="#">Intercity Routes</a></li>
            </ul>
        </div>
        ...
        <div class="footer-section">
            ...
            <ul>
                <li>123 Bus Terminal Way,</li>
                <li>Canberra, ACT 2601</li>
                <li>Australia</li>
                <li>Phone: +61 2 1234 5678</li>
                <li>Email: info@gobus.com.au</li>
            </ul>
        </div>
    </div>
    ...
    <div class="footer-bottom">
        <div class="social-media">
            ...
            <a href="#" aria-label="Twitter">
                <svg width="24px" height="24px" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M23 3.01006C23 3.01006 20.9821 4.20217 19.86 4.54006C19.2577 3.84757 18.4573 3.35675 17.567 3.13398C16.6767 2.91122 15.7395 2.96725 14.8821 3.29451C14.0247 3.62177 13.2884 4.20446 12.773 4.96377C12.2575 5.72309 11.9877 6.62239 12 7.54006V8.54006C10.2426 8.58562 8.50127 8.19587 6.93101 7.4055C5.36074 6.61513 4.01032 5.44869 3 4.01006C3 4.01006 -1 13.0101 8 17.0101C5.94053 18.408 3.48716 19.109 1 19.0101C10 24.0101 21 19.0101 21 7.51006C20.9991 7.23151 20.9723 6.95365 20.92 6.68006C21.9406 5.67355 23 3.01006 23 3.01006Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                </svg>
            </a>
        ...
        <p>&copy; <?php echo date("Y"); ?> GOBus Australia. All rights reserved.</p>
    </div>
</footer>
